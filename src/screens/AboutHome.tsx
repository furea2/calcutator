...
`}
        />
        <Text style={{alignItems: "center",justifyContent: 'center',fontSize: 16, fontWeight: 'bold'}}>
          {"・More Further contents"}
        </Text>
        <Button title="A homotopy group of spheres."
            onPress={()=>navigation.navigate("AboutPi_4_3")} />
        <Text>{""}</Text>
