...
const FunctionSetGroup = ({ navigation, route }) => {
  ...
  const handleOnPressEval = () => {
    try {
      navigation.navigate("FunctionHome", {setType:route.params.setType,term_list:term_list});
...
export default FunctionSetGroup;
